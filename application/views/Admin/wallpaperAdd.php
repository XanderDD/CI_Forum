...
<div class="f3">
	<h3>
		<?php if(isset($error)){ print_r($error); } ?><br>
		First:You must confirm the picture and video are same.<br>
		Second:The files Name is true!
	</h3>
	<form method="post" action="/CI_FORUM/index.php/Admin/wallpaperAddDB" enctype="multipart/form-data">
		Wallpaper URL:<input type="file" name="wallpaper" /><br>
